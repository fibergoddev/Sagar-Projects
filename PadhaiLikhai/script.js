 ...
 * Version 40: Definitive Unbreakable Initialization
 */
...
// ** THE DEFINITIVE FIX **: The corrected and final configuration.
...
const allDOMElements = {
    ...
    nexusHubBtn: document.getElementById('nexus-hub-btn'),
};
...
async function main() {
    try {
        ...
        // ** THE FIX **: App flow starts ONLY AFTER successful authentication.
        initializeMainApp();

    } catch (error) {
        console.error("Firebase Initialization Error:", error);
        allDOMElements.loaderStatus.innerHTML = `
...
// This function contains all the logic that should only run AFTER Firebase is ready.
function initializeMainApp() {
    ...
    // ** THE FIX **: The loader is hidden and the app is shown ONLY after everything is ready.
    setTimeout(() => {
